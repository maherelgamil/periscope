...
{
    return new class($uuid, $queue, $name, $attempts) implements \Illuminate\Contracts\Queue\Job
    {
        ...
        public function getJobId(): string { return 'job-'.$this->uuid; }
        public function getRawBody(): string { return json_encode(['uuid' => $this->uuid, 'displayName' => $this->name]); }
        public function payload(): array { return ['uuid' => $this->uuid, 'displayName' => $this->name]; }
        ...
        public function backoff(): ?int { return null; }
        public function retryUntil(): ?int { return null; }
        public function timeout(): ?int { return null; }
        public function getConnectionName(): string { return 'sync'; }
        public function getResolvedName(): string { return $this->name; }
        public function resolveName(): string { return $this->name; }
        public function resolveQueuedJobClass(): string { return $this->name; }
    };
}
